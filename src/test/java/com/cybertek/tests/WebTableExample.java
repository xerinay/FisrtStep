...
public class WebTableExample extends TestBase {
    // to format your code you need to use:
// Ctrl+Alt+l
    @Test
    ...
    /*
    print the size : columns and rows
     */
    @Test
    public void printTableSize() {
        login();
        List<WebElement> allRows = driver.findElements(By.xpath("//table[@id='ctl00_MainContent_orderGrid']/tbody/tr"));
        System.out.println("(Size table) number of rows: " + allRows.size());
    ...
    /*
    print all the cells of a row whose index is
     */
    @Test
  ...
  */
    ...
    public void test(){
        ...
        System.out.println("this name is on column "+nameIndex);
        ...
        System.out.println("This city is on column "+cityIndex);
